...
* Scale-free measure of each (covariate, cluster, cruise) to be compared across
  cruises. One idea is an ANOVA-type ratio of variance e.g. $var(X^T
  beta_{salinity, k}) / var(\mu_k)$.
* Proper usage of random seeds (for experiments to be reproducible).
* Calculate stability: 100x repeats of experiments.
...
* Fix the error (in the software) when using covariates scaled the same across
  all cruises.
