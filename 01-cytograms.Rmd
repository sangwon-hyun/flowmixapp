...
Here are all the pilot cruises:
...
Here are the non-pilot cruises:
...
# for cruise_id in MGL1704 KM1708 KM1709 KM1712 KM1713 KM1717 KM1802 KM1805 KOK1801
for cruise_id in MGL1704 KM1708 KM1713 KM1717 KM1802 KM1805 KOK1801 KM1513
# for cruise_id in MGL1704 KM1708 KM1709 
# for cruise_id in KM1712 KM1709 KM1713 KM1802 KM1805 KOK1803 FK180310-1 FK180310-2;
# for cruise_id in FK180310-2;
# for cruise_id in FK180310-1 FK180310-2 MGL1704
# for cruise_id in KM1709
for cruise_id in KM1513
  do
    echo $cruise_id
...
# for cruise_id in KM1508 KM1512 KM1513 KOK1515 KM1518 KM1508 KM1512 KM1513 KOK1515 KM1518 KOK1604 KM1510 KM1601 KM1602 KOK1607 KOK1609  KOK1608 

# for cruise_id in KM1508 
# do
#     from=sangwonh@discovery.usc.edu:~/scratchdir/output/flowmixapp/data/01-cytograms/$cruise_id/data-no-wind/$cruise_id-datobj.RDS
# #     to=~/scratchdir/output/flowmixapp/data/01-cytograms/$cruise_id/data-no-wind/.
#     to=~/repos/flowmixapp/data/01-cytograms/$cruise_id/data-no-wind
# 	mkdir -p $to
# 	scp $from $to
# done
...
(Assume the processed and binned data files `KM1508-datobj.Rdata` files have
been downloaded.)
...
for(cruise_id in all_cruise_id){
  ...
  for(tt in 1:TT){
    ...
    plotfile = file.path(datadir, "01-cytograms", cruise_id, "viz", filename)
    ## if(!file.exists(plotfile)){
      p = plot_2d_threepanels(ylist = ylist, countslist = qclist, tt = tt, colours = coul, cruise_id = cruise_id)
